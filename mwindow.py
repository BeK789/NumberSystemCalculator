...
def press(num):
    ...
    label.configure(text="Enter digits less than the BASE NUMBER or it will give you incorrect result.")
...
def clear():
    ...
    equation1.set("")
    equation2.set("")
    label.configure(text="Record Cleared")
    label.after(3000, lambda: label.configure(text=""))
...
def reset():
    ...
    label.configure(text="Reset Done...")
    label.after(3000, lambda: label.configure(text=""))
...
def Convert():
    ...
    if variable1.get() == OptionList1[0] and variable2.get() == OptionList2[0]:
        label.configure(text="Error! Choose Different Option")
        label.after(3000, lambda: label.configure(text = ""))
...
frame2 = Frame(mwindow)
frame2.grid(row=0, column=4, columnspan=2, padx=50, pady=20)

variable2 = StringVar()
variable2.set(OptionList2[0])
OptionMenu2 = OptionMenu(frame2, variable2, *OptionList2)
OptionMenu2.config(width=8, font=('fangsongti', 12), bd=1, bg="#FFFFFF")
OptionMenu2.grid(row=1, column=0, padx=20)

equation2 = StringVar()
equation2.set("")
resultlabel = Label(frame2, textvariable=equation2, width=25, bd=1, bg="#EBF7FE")
...
label = Label(frame4, text="WelCome !", padx=50, pady=5)
...
button1 = Button(frame3, text="1", command=lambda: press(1), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button1.grid(row=1, column=1)

button2 = Button(frame3, text="2", command=lambda: press(2), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button2.grid(row=1, column=2)

button3 = Button(frame3, text="3", command=lambda: press(3), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button3.grid(row=1, column=3)

button4 = Button(frame3, text="4", command=lambda: press(4), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button4.grid(row=1, column=4)

button5 = Button(frame3, text="5", command=lambda: press(5), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button5.grid(row=2, column=1)

button6 = Button(frame3, text="6", command=lambda: press(6), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button6.grid(row=2, column=2)

button7 = Button(frame3, text="7", command=lambda: press(7), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button7.grid(row=2, column=3)

button8 = Button(frame3, text="8", command=lambda: press(8), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button8.grid(row=2, column=4)

button9 = Button(frame3, text="9", command=lambda: press(9), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button9.grid(row=3, column=1)

button0 = Button(frame3, text="0", command=lambda: press(0), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
button0.grid(row=3, column=2)

buttonA = Button(frame3, text="A", command=lambda: press("A"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
buttonA.grid(row=3, column=3)

buttonB = Button(frame3, text="B", command=lambda: press("B"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
buttonB.grid(row=3, column=4)

buttonC = Button(frame3, text="C", command=lambda: press("C"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
buttonC.grid(row=4, column=1)

buttonD = Button(frame3, text="D", command=lambda: press("D"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
buttonD.grid(row=4, column=2)

buttonE = Button(frame3, text="E", command=lambda: press("E"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
buttonE.grid(row=4, column=3)

buttonF = Button(frame3, text="F", command=lambda: press("F"), height=1, width=7, background="#666666",
                 foreground="#FFFFFF", bd="5")
...
convert = Button(frame5, text="Convert", command=Convert, height=1, width=7, background="DarkGreen",
                 foreground="#FFFFFF", padx=20, bd="3")
convert.grid(row=3, column=5)

Reset = Button(frame5, text="Reset", command= reset, height=1, width=7, background="pink",
                   foreground="#FFFFFF", bd="3")
Reset.grid(row=3, column=2, columnspan=2, padx=5)

clear = Button(frame5, text="Clear", command=clear, height=1, width=7, background="DarkRed", foreground="#FFFFFF",
               padx=20, bd="3")
